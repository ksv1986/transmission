...
void FilterBar::refreshFilter(Map& map, QStandardItemModel* model, Counts& counts, QStandardItem* (*update)(QStandardItem* i, MapIter const& it), int key)
{
    enum
    {
    ...
    myIsBootstrapping(true)
{
    ...
    myPathCombo = createPathCombo(myPathModel);
